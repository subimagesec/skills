...
| [`subimage-setup:connect-gcp`](./skills/connect-gcp/SKILL.md) | Create GCP WIF principal bindings, or fall back to a service account key when WIF is not possible. |
